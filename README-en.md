...
- **Code** (the `scripts/` folder and repository tooling): licensed under the [3-Clause BSD NON-AI License](LICENSE). You may use, modify, and redistribute the code provided you keep the copyright notice and follow the license terms.
